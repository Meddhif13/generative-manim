...
"""
    ...
    # Anthropic engine disabled for local setup. Use engine="openai" and an OpenAI model instead.
    if engine == "anthropic":
        return jsonify({"error": "Anthropic support is disabled. Use engine 'openai' with model 'gpt-4o'."}), 400
